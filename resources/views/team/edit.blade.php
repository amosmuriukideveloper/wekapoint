                            ...
                            <div class="form-group">
                                ...
                                <div id="team_members">
                                    ...
                                    <div class="team-member">
                                        <input type="text" name="team_members[]" class="form-control" placeholder="Member Name" value="{{ $member->name }}">
                                        <input type="text" name="team_members[]" class="form-control" placeholder="Member Age" value="{{ $member->age }}">
                                    </div>
                                    @endforeach
                                </div>
